...
//                  resourceAllocation.setClientEmailID(........);
                ...
                }else if(requestBody.get("message")==null || !requestBody.get("message").equals("Extension Rejected")){
                    ...
                    updated.setAllocEndDate(updated.getExtendedDate());
                    resourceAllocProcessRepository.save(updated);
